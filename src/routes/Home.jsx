...
function Home() {
  return (
    <div className="max-w-10xl p-2 text-center">
      ...
      <div className="flex flex-col lg:flex-row justify-center items-center mt-40 mr-20">
        {/* Left Section: Image */}
        ...
        <div className="lg:w-2/3 flex flex-col justify-center">
          ...
          <div className="bg-white/80 hover:bg-white/90 p-4 rounded-xl shadow-md w-full max-w-6xl mx-auto flex flex-col justify-center items-center transition-opacity duration-300">
